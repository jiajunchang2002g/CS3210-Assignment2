...
void runMatcher(const std::vector<klibpp::KSeq> &samples, const std::vector<klibpp::KSeq> &signatures,
...
int main(int argc, char *argv[])
{
        ...
        {
                std::cout << match.sample_name << ": " << match.signature_name << " (" << std::fixed << std::setprecision(3)
                        << match.match_score << ") [" << match.integrity_hash << "]\n";
        }
